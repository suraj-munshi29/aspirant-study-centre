...
export const AiLoader: React.FC<LoaderProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#090d16] transition-all duration-700">
      <div
      ...
      >
        {letters.map((letter, index) => (
          <span
            key={index}
            className="inline-block text-white font-extrabold tracking-widest text-3xl opacity-40 animate-loaderLetter"
